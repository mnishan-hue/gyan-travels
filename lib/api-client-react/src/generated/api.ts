...
export const getGetWaitlistCountQueryOptions = <TData = Awaited<ReturnType<typeof getWaitlistCount>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWaitlistCount>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetWaitlistCountQueryError = ErrorType<ErrorResponse>
...
export function useGetWaitlistCount<TData = Awaited<ReturnType<typeof getWaitlistCount>>, TError = ErrorType<ErrorResponse>>(
